function OverviewSection() {
  return (
    <section className="overview">
      <div className="row">
        <div className="col overview__text">
          <h1>
            BASIC/DEPT® is a global branding and digital design agency building products, services,
            and eCommerce experiences that turn cultural values into company value.
          </h1>
        </div>
        <div className="col overview__logos">
          <figure>
